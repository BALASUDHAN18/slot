...
<html>
<head>
    <title>SLOT TIME TABLE - P.Balasudhan (212222240017)</title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - BALASUDHAN (212222240017) </strong></p>
    </div>
    <table>
        <tr>
...
## OUTPUT
![timetable](https://github.com/BALASUDHAN18/slot/assets/118807740/18cc6cf4-7348-48da-905b-1bc9bbab6da3)
## RESULT
